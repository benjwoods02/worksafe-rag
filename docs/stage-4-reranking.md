...
**Score separation:** cross-encoder logits now span roughly 3–7 on real queries
...
7–8 correct chunks each, so `recall@5` is mathematically capped near 0.6.
...
(0–1) at earlier stages. No threshold has ever survived a change of retrieval
